...
export type TrapezoidBackgroundPropsType = {
  width: ScaledSize["width"];
  height: ScaledSize["height"];
};

export const TrapezoidBackground = ({
  width,
  height,
}: TrapezoidBackgroundPropsType) => {
  const { Path1, Path2 } = COLORS.TabBar.TabBarItems.TrapezoidBackground;
      ...
      <FitBox src={rect(0, 0, 266, 100)} dst={rect(0, 0, width, height)}>
        ...
        >
          <LinearGradient
            ...
            colors={[Path1.LinearGradient["0%"], Path1.LinearGradient["100%"]]}
          />
        </Path>
        <Path
          path={
